...
jest.mock('@shared/navigation/ClusterDropDown', () => ({
  __esModule: true,
...
jest.mock('@shared/CustomBackButton', () => ({
  __esModule: true,
...
describe('Header1', () => {
  ...
  describe('user menu (help)', () => {
    ...
    it('shows Documentation menu item for non-onPrem', async () => {
      useSession.mockReturnValue({
        data: { onPrem: false, appVersion: 'v1.0.0' },
      });
      await act(async () => {
        render(<Header1 />);
      });
    ...
    it('hides Chat with us for onPrem users', async () => {
      useSession.mockReturnValue({
        data: { onPrem: true, appVersion: 'v1.0.0' },
      });
      await act(async () => {
        render(<Header1 />);
      });
