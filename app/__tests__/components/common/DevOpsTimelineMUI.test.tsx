...
jest.mock('@shared/WidgetCard', () => ({ children }: { children: React.ReactNode }) => <div data-testid='widget-card'>{children}</div>);
jest.mock('@shared/CopyableText', () => ({ children }: { children: React.ReactNode }) => <div data-testid='copyable-text'>{children}</div>);
