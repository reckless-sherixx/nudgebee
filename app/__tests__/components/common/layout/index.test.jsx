...
import PageLayoutWrapped from '@shared/layout/index';
...
describe('PageLayout (index.jsx)', () => {
  ...
  it('handles Logout menu item click', async () => {
    const { generateMenuItems } = require('@shared/layout/UserMenuItems');
    generateMenuItems.mockReturnValue(['UserInfo', 'Logout', 'Switch Tenant', 'API Tokens']);

    const { createGetMenuItem } = require('@shared/layout/UserMenuItems');
