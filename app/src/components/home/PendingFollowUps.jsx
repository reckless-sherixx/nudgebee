...
const PendingFollowUps = ({ accountId }) => {
  ...
  return (
    <Card size='sm' elevation='flat' header={header} sx={{ minHeight: ds.space.mul(0, 45), overflow: 'hidden' }}>
      ...
      {!loading && displayItems.length === 0 && (
        <Box sx={{ py: 'var(--ds-space-3)', textAlign: 'center' }}>
                ...
                >
                  ...
                  >
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      ...
                      />
                      <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 'var(--ds-space-1)', mt: 'var(--ds-space-1)', flexWrap: 'wrap' }}>
                        {srcCfg && (
                          <Chip
                            variant='tag'
                            size='xs'
                        ...
                        <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: 'var(--ds-gray-400)', mt: 'var(--ds-space-1)' }}>
