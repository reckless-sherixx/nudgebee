...
import KubernetesGroupedEventTypeTable from '@components/k8s/details/groupedevents/KubernetesGroupedEventTypeTable';
import KubernetesGroupedApplications from '@components/k8s/details/groupedevents/KubernetesGroupedApplications';
...
const KubernetesGroupedEvents: React.FC<KubernetesGroupedEventsProps> = ({ accountId = '' }) => {
  ...
  return (
    <>
      <Box sx={{ display: 'flex', padding: `${ds.space[1]} ${ds.space[3]} ${ds.space[3]} 0` }}>
