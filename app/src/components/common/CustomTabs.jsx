/**
 * @deprecated Use `Tabs` from '@ui/Tabs' with `navigation="router"` instead.
...
function _warnCustomTabs() {
  ...
  console.warn(
    '[deprecated] CustomTabs is deprecated. Use `import { Tabs } from "@ui/Tabs"` with navigation="router" instead. ' +
